              ...
              'Hauteur de vol en suivi de terrain' && (
                <div>
                  ...
                  <input
                    ...
                    className={`mt-1 block w-full rounded-md shadow-sm focus:ring-blue-500 ${assessment.followTerrainHeight === undefined
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  {assessment.DetailedJarusModel === 'OUI' && (
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`mt-1 block w-full rounded-md shadow-sm focus:ring-blue-500 ${assessment.ThetaGlide === undefined
                          ? 'border-red-300 focus:border-red-500 bg-red-50'
                          : 'border-gray-300 focus:border-blue-500'
                          }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      step="0.01"
                      className={`mt-1 block w-full rounded-md shadow-sm focus:ring-blue-500 ${assessment.dGlide === undefined
                        ? 'border-red-300 focus:border-red-500 bg-red-50'
                        : 'border-gray-300 focus:border-blue-500'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      step="0.01"
                      className={`mt-1 block w-full rounded-md shadow-sm focus:ring-blue-500 ${assessment.dSlideReduced === undefined
                        ? 'border-red-300 focus:border-red-500 bg-red-50'
                        : 'border-gray-300 focus:border-blue-500'
                        }`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`mt-1 block w-full rounded-md shadow-sm focus:ring-blue-500 ${assessment.ContingencyVolumeSGPS === undefined
                    ? 'border-red-300 focus:border-red-500 bg-red-50'
                    : 'border-gray-300 focus:border-blue-500'
                    }`}
              ...
              <div>
                ...
                <input
                  ...
                  step="0.1"
                  min={0.0} // Définit la valeur minimale autorisée
                  className={`mt-1 block w-full rounded-md shadow-sm focus:ring-blue-500 ${assessment.ContingencyVolumeHbaro === undefined
                    ? 'border-red-300 focus:border-red-500 bg-red-50'
                    : 'border-gray-300 focus:border-blue-500'
                    }`}
                  placeholder={'TO BE DEFINED'}
              ...
              <div>
                ...
                <input
                  ...
                  className={`mt-1 block w-full rounded-md shadow-sm focus:ring-blue-500 ${assessment.ContingencyVolumeSpos === undefined
                    ? 'border-red-300 focus:border-red-500 bg-red-50'
                    : 'border-gray-300 focus:border-blue-500'
                    }`}
                  placeholder={'TO BE DEFINED'}
              ...
              <div>
                ...
                <input
                  ...
                  step="0.1"
                  min={0.0} // Définit la valeur minimale autorisée
                  className={`mt-1 block w-full rounded-md shadow-sm focus:ring-blue-500 ${assessment.ContingencyVolumeSK === undefined
                    ? 'border-red-300 focus:border-red-500 bg-red-50'
                    : 'border-gray-300 focus:border-blue-500'
                    }`}
                  placeholder={'TO BE DEFINED'}
              ...
              <div>
                ...
                <input
                  ...
                  step="0.1"
                  min={0.0} // Définit la valeur minimale autorisée
                  className={`mt-1 block w-full rounded-md shadow-sm focus:ring-blue-500 ${assessment.ContingencyTimeRZ === undefined
                    ? 'border-red-300 focus:border-red-500 bg-red-50'
                    : 'border-gray-300 focus:border-blue-500'
                    }`}
                  placeholder={'TO BE DEFINED'}
                  ...
                  <div>
                    <div>
                      ...
                      <input
                        ...
                        className={`mt-1 block w-full rounded-md shadow-sm focus:ring-blue-500 ${assessment.ParachuteTime === undefined
                          ? 'border-red-300 focus:border-red-500 bg-red-50'
                          : 'border-gray-300 focus:border-blue-500'
                          }`}
                        placeholder={'TO BE DEFINED'}
                    ...
                    {(assessment.uasType || []).includes('Héli') || (assessment.uasType || []).includes('Multi') ? (
                      ...
                      <div><Tooltip text={
                        ...
                        <input
                          ...
                          className={`mt-1 block w-full rounded-md shadow-sm focus:ring-blue-500 ${assessment.PhiMaxPlane === undefined
                            ? 'border-red-300 focus:border-red-500 bg-red-50'
                            : 'border-gray-300 focus:border-blue-500'
                            }`}
                          placeholder={'TO BE DEFINED'}
              ...
              <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`mt-1 block w-full rounded-md shadow-sm focus:ring-blue-500 ${assessment.VzParachute === undefined
                      ? 'border-red-300 focus:border-red-500 bg-red-50'
                      : 'border-gray-300 focus:border-blue-500'
                      }`}
                    placeholder={"6.0"}
