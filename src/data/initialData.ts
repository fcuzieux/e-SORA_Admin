...
export const initialSoraForm: SoraForm = {
  ...
  operation: {
    ...
    droppingMaterials: null,
    droppingMaterialsDescription: '',
    controlMultipleDrones: null,
    controlMultipleDronesNumber: 0,
    controlMultipleDronesDescription: '',
    maxOperationHeight: 0,
    dayNightOperation: null,
    operationStartTime: '',
    operationEndTime: '',
  ...
  RiskAssessment: {
    assessmentTypeHauteurVol: 'Hauteur de vol suivant trajectoire(s)',
    assessmentCriticalArea: 'Calcul selon les Modèles JARUS',
    ...
    uspaceProvider: '',
    otherDetails: '',
    StrategicMitigationOperationalRestrictionsAvailable: 'NON',
    StrategicMitigationOperationalRestrictionsJustification: '',
    StrategicMitigationCommonStructuresAvailable: 'NON',
    StrategicMitigationCommonStructuresJustification: '',
    OperationalVolumeLevelMitigated: 'ARC-a',
    TacticalMitigationAvailable: 'NON',
